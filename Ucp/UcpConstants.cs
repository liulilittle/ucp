...
namespace Ucp
{
    ...
    internal static class UcpConstants
    {
        ...
        /// </remarks>
        public const long MICROS_PER_SECOND = 1000000L; // Runtime: denominator in BBR pacing-gap calculations (bytes/sec → bytes/μs).
        ...
        /// </remarks>
        public const long NANOS_PER_MICRO = 1000L; // Runtime: multiplier when converting System.Diagnostics.Stopwatch timestamps (ns) into UCP μs domain.
        ...
        /// </remarks>
        public const double BITS_PER_BYTE = 8d; // Runtime: multiplier in diagnostic throughput-Mbps conversion (bytes/sec × 8 → bits/sec).
        ...
        /// </remarks>
        public const double BITS_PER_MEGABIT = 1000000d; // Runtime: divisor when normalizing bits-per-second to user-facing Mbps display.
        ...
        /// </remarks>
        public const int INITIAL_CWND_PACKETS = 20; // Runtime: BBR Startup initial inflight allowance; spread by the pacer across one RTT.
        ...
        /// </remarks>
        public const int DEFAULT_INITIAL_CONGESTION_WINDOW = 4 * MSS; // Runtime: legacy floor for CWND start (4880 bytes); used by older callers and test harnesses.
        ...
        /// </remarks>
        public const long MIN_RTO_MICROS = 20000L; // Runtime: config validation floor; any user RTO below 20 ms is rejected.
        ...
        /// timeout prematurely.
        /// </remarks>
        public const long INITIAL_RTO_MICROS = 100000L; // Runtime: used for the first SYN retransmission timer before any RTT sample exists.
        ...
        /// </remarks>
        public const long RTO_ACK_PROGRESS_SUPPRESSION_MICROS = 2 * MICROS_PER_MILLI; // Runtime: if ACK arrived ≤2 ms ago, skip bulk RTO retransmission.
        ...
        /// </remarks>
        public const int RTO_MAX_BACKOFF_MIN_RTO_MULTIPLIER = 2; // Runtime: backed-off RTO is clamped to ≤2 × MIN_RTO_MICROS (40 ms) to bound worst case.
        ...
        /// </remarks>
        public const int BBR_WINDOW_RTT_ROUNDS = 10; // Runtime: BBR max-filter holds up to 10 RTT rounds; dropping old ones changes BtlBw estimate.
        ...
        /// </remarks>
        public const int BBR_RECENT_RATE_SAMPLE_COUNT = 10; // Runtime: one delivery-rate sample per RTT; the max of these is the current BtlBw.
        ...
        /// </remarks>
        public const int BBR_PROBE_BW_GAIN_COUNT = 8; // Runtime: BBR rotates through 8 pacing-gain phases each ProbeBW cycle.
        ...
        /// </remarks>
        public const int BBR_MIN_STARTUP_FULL_BANDWIDTH_ROUNDS = 3; // Runtime: Startup exits to Drain after 3 consecutive rounds of sub-25% growth.
        ...
        /// </remarks>
        public const double BBR_STARTUP_GROWTH_TARGET = 1.25d; // Runtime: per-round growth threshold; <25% growth for 3 rounds exits Startup.
        ...
        /// </remarks>
        public const double BBR_STARTUP_PACING_GAIN = 2.89d; // Runtime: Startup phases pace data at 2.89× estimated BtlBw.
        ...
        /// </remarks>
        public const double BBR_STARTUP_CWND_GAIN = 2.0d; // Runtime: Startup inflight cap = 2.0 × BDP; ensures pacer, not CWND, governs rate.
        ...
        /// </remarks>
        public const double BBR_DRAIN_PACING_GAIN = 1.0d; // Runtime: Drain phase pacing = exactly BtlBw; drains the Startup queue without adding new flight.
        ...
        /// </remarks>
        public const double BBR_PROBE_BW_HIGH_GAIN = 1.35d; // Runtime: one ProbeBW phase each cycle paces 35% above BtlBw to find more capacity.
        ...
        /// </remarks>
        public const double BBR_PROBE_BW_LOW_GAIN = 0.85d; // Runtime: one ProbeBW phase each cycle paces 15% below BtlBw to drain queues.
        ...
        /// </remarks>
        public const double BBR_PROBE_BW_CWND_GAIN = 2.0d; // Runtime: ProbeBW inflight cap = 2.0 × BDP; same headroom as Startup.
        ...
        /// </remarks>
        public const double BBR_PROBE_RTT_PACING_GAIN = 0.85d; // Runtime: ProbeRTT paces at 85% of BtlBw; prevents zero-throughput stalls.
        ...
        /// </remarks>
        public const long BBR_PROBE_RTT_INTERVAL_MICROS = 30000000L; // Runtime: enters ProbeRTT at most once every 30 s; impacts loss-recovery sizing.
        ...
        /// artifacts.
        /// </remarks>
        public const long BBR_PROBE_RTT_DURATION_MICROS = 100000L; // Runtime: minimum time spent in ProbeRTT mode each invocation.
        ...
        /// </remarks>
        public const int BBR_PROBE_RTT_MAX_DURATION_MULTIPLIER = 2; // Runtime: caps ProbeRTT at 2× current RTT; prevents indefinite draining.
        ...
        /// is already empty.
        /// </remarks>
        public const double BBR_PROBE_RTT_EXIT_RTT_MULTIPLIER = 1.05d; // Runtime: exit ProbeRTT early if RTT ≤ 1.05× known minimum.
        ...
        /// </remarks>
        public const double BBR_LOW_RTT_INCREASE_RATIO = 0.10d; // Runtime: RTT increase <10% → path is "green"; probing unrestricted.
        ...
        /// queue into loss.
        /// </remarks>
        public const double BBR_MODERATE_RTT_INCREASE_RATIO = 0.20d; // Runtime: RTT increase 10–20% → moderate probing; >20% → restricted probing.
        ...
        /// continues unimpeded.
        /// </remarks>
        public const double BBR_LOW_LOSS_RATIO = 0.01d; // Runtime: loss <1% → high-gain probing allowed (path considered clean).
        ...
        /// </remarks>
        public const double BBR_MODERATE_LOSS_RATIO = 0.03d; // Runtime: loss 1–3% → moderate loss tier; permits moderate probing gain.
        ...
        /// </remarks>
        public const double BBR_LIGHT_LOSS_RATIO = 0.08d; // Runtime: loss <8% → light loss tier; applies 1.10× pacing gain.
        ...
        /// </remarks>
        public const double BBR_MEDIUM_LOSS_RATIO = 0.15d; // Runtime: loss 8–15% → medium loss tier; applies 1.05× pacing gain.
        ...
        /// </remarks>
        public const double BBR_MODERATE_PROBE_GAIN = 1.50d; // Runtime: used when RTT is moderately elevated but loss remains low (mobile recovery).
        ...
        /// </remarks>
        public const double BBR_LIGHT_LOSS_PACING_GAIN = 1.10d; // Runtime: applied at light loss (<8%); compensates retransmission overhead.
        ...
        /// </remarks>
        public const double BBR_MEDIUM_LOSS_PACING_GAIN = 1.05d; // Runtime: applied at medium loss (8–15%); minimal throughput boost.
        ...
        /// </remarks>
        public const double BBR_HIGH_LOSS_PACING_GAIN = 1.00d; // Runtime: applied at high loss (>15%); no pacing boost — sends at exactly BtlBw.
        ...
        /// </remarks>
        public const double BBR_FAST_RECOVERY_PACING_GAIN = 1.25d; // Runtime: after a non-congestion loss event, temporarily pace 25% above BtlBw.
        ...
        /// is 0.92 × 0.98 ≈ 0.90.
        /// </remarks>
        public const double BBR_MIN_CONGESTION_PACING_GAIN = 0.92d; // Runtime: floor multiplier on pacing after confirmed congestion.
        ...
        /// </remarks>
        public const double BBR_CONGESTION_LOSS_REDUCTION = 0.98d; // Runtime: 2% pacing reduction per confirmed congestion signal.
        ...
        /// </remarks>
        public const double BBR_MIN_LOSS_CWND_GAIN = 0.95d; // Runtime: CWND gain floor after congestion; prevents collapse below 95% of BDP.
        ...
        /// </remarks>
        public const double BBR_LOSS_CWND_RECOVERY_STEP = 0.08d; // Runtime: CWND gain increments 0.08 per ACK during standard recovery (~12 ACKs → full).
        ...
        /// outage ends.
        /// </remarks>
        public const double BBR_LOSS_CWND_RECOVERY_STEP_FAST = 0.15d; // Runtime: CWND gain increments 0.15 per ACK during fast recovery (~7 ACKs → full).
        ...
        /// </remarks>
        public const double BBR_LOSS_BUDGET_RECOVERY_RATIO = 0.80d; // Runtime: probing resumes when loss budget usage drops to ≤80% (hysteresis).
        ...
        /// </remarks>
        public const double BBR_LOSS_EWMA_SAMPLE_WEIGHT = 0.25d; // Runtime: loss EWMA ← 0.25×new + 0.75×old each window.

        /// <summary>EWMA retained weight used to smooth exported loss estimates.</summary>
        /// <remarks>
        /// (1 − 0.25) = 0.75 weight on the previous estimate.
        /// </remarks>
        public const double BBR_LOSS_EWMA_RETAINED_WEIGHT = 1d - BBR_LOSS_EWMA_SAMPLE_WEIGHT; // Runtime: complement of sample weight; 0.75 keeps historical estimate.
        ...
        /// </remarks>
        public const double BBR_LOSS_EWMA_IDLE_DECAY = 0.90d; // Runtime: loss EWMA ← old × 0.90 when no loss detected in current window.
        ...
        /// </remarks>
        public const double BBR_CONGESTION_RATE_DROP_RATIO = -0.15d; // Runtime: rate drop ≥15% from max → +1 congestion-classifier point.
        ...
        /// </remarks>
        public const double BBR_RANDOM_LOSS_MAX_RTT_INCREASE_RATIO = 0.20d; // Runtime: if RTT ≤1.20× min despite loss → loss treated as random, not congestion.
        ...
        /// any single metric.
        /// </remarks>
        public const int BBR_CONGESTION_CLASSIFIER_SCORE_THRESHOLD = 2; // Runtime: composite score ≥2 required before triggering congestion response.

        /// <summary>Classifier score assigned to a meaningful delivery-rate drop.</summary>
        public const int BBR_CONGESTION_RATE_DROP_SCORE = 1; // Runtime: +1 point on the congestion classifier when rate drops ≥15%.

        /// <summary>Classifier score assigned to sustained RTT growth.</summary>
        public const int BBR_CONGESTION_RTT_GROWTH_SCORE = 1; // Runtime: +1 point when RTT inflates beyond the low-RTT-increase threshold.

        /// <summary>Classifier score assigned to moderate recent loss while RTT is also growing.</summary>
        public const int BBR_CONGESTION_LOSS_SCORE = 1; // Runtime: +1 point when loss is present and RTT is elevated above threshold.
        ...
        /// </remarks>
        public const double BBR_RATE_LOSS_HINT_MAX_RATIO = 0.05d; // Runtime: inferred "hidden" loss cap when rate drops exceed measured retransmission.
        ...
        /// </remarks>
        public const double BBR_STARTUP_ACK_AGGREGATION_RATE_CAP_GAIN = 4.0d; // Runtime: Startup delivery-rate samples capped at 4.0× pacing rate.
        ...
        /// </remarks>
        public const double BBR_STEADY_ACK_AGGREGATION_RATE_CAP_GAIN = 1.50d; // Runtime: steady-state delivery-rate samples capped at 1.50× pacing rate.
        ...
        /// </remarks>
        public const double BBR_STARTUP_BANDWIDTH_GROWTH_PER_ROUND = 2.0d; // Runtime: Startup BtlBw capped at 2× per RTT round; prevents estimate overshoot.
        ...
        /// infrequent).
        /// </remarks>
        public const double BBR_STEADY_BANDWIDTH_GROWTH_PER_ROUND = 1.25d; // Runtime: steady-state BtlBw capped at 1.25× per RTT round.
        ...
        /// </remarks>
        public const double BBR_CONGESTION_LOSS_RTT_MULTIPLIER = 1.10d; // Runtime: loss only counts toward congestion score if RTT ≥1.10× min.
        ...
        /// </remarks>
        public const int BBR_RANDOM_LOSS_MAX_DEDUPED_EVENTS = 2; // Runtime: ≤2 loss events/window → random; >2 but RTT not elevated → ambiguous.
        ...
        /// must also be elevated for the congestion classifier to respond.
        /// </remarks>
        public const int BBR_CONGESTION_LOSS_WINDOW_THRESHOLD = 3; // Runtime: ≥3 loss events/window crosses into potential-congestion territory.
        ...
        /// drops.
        /// </remarks>
        public const int BBR_CONGESTION_LOSS_BURST_THRESHOLD = 3; // Runtime: NAK with ≥3 missing → classified as burst (clustered) loss.
        ...
        /// </remarks>
        public const long BBR_BANDWIDTH_GROWTH_FALLBACK_INTERVAL_MICROS = 10000L; // Runtime: bandwidth estimate updates every 10 ms before first RTT sample.
        ...
        /// </remarks>
        public const double BBR_INFLIGHT_LOW_GAIN = 1.25d; // Runtime: minimum inflight = 1.25 × BDP; prevents sender starvation from ACK compression.
        ...
        /// </remarks>
        public const double BBR_INFLIGHT_HIGH_GAIN = 2.00d; // Runtime: max inflight = 2.00 × BDP; sender pauses when exceeded (bufferbloat guard).
        ...
        /// on these paths.
        /// </remarks>
        public const double BBR_INFLIGHT_MOBILE_HIGH_GAIN = 2.00d; // Runtime: same as standard high-gain for mobile paths; pacer is dominant.
        ...
        /// real-world paths.
        /// </remarks>
        public const double BBR_CONGESTION_RTT_INCREASE_RATIO = 0.50d; // Runtime: rate drops only classified as congestion if RTT ≥1.50× min.
        ...
        /// </remarks>
        public const double BBR_CONGESTION_LOSS_RATIO = 0.10d; // Runtime: loss must exceed 10% before contributing to congestion classification.
        ...
        /// </remarks>
        public const double BBR_RANDOM_LOSS_CWND_RTT_CUSHION = 2.0d; // Runtime: extra CWND headroom on random-loss paths = 2.0× RTT worth of data.
        ...
        /// </remarks>
        public const int BBR_DELIVERY_RATE_HISTORY_COUNT = 16; // Runtime: ring buffer of 16 delivery-rate samples for trend detection.
        ...
        /// </remarks>
        public const int BBR_RTT_HISTORY_COUNT = 32; // Runtime: 32-sample ring buffer for RTT percentile computation (jitter/network classification).
        ...
        /// </remarks>
        public const long BBR_LOSS_BUCKET_MICROS = 100000L; // Runtime: each loss-tracking bucket spans 100 ms; 10 buckets = 1 s of loss history.
        ...
        /// </remarks>
        public const int BBR_LOSS_BUCKET_COUNT = 10; // Runtime: 10-loss-bucket ring determines the loss-rate estimate window (~1 s).
        ...
        /// </remarks>
        public const long BBR_MIN_ROUND_DURATION_MICROS = MICROS_PER_MILLI; // Runtime: state-machine evaluation floor = 1 ms before first RTT sample.
        ...
        /// </remarks>
        public const long BBR_DEFAULT_RATE_WINDOW_MICROS = MICROS_PER_SECOND; // Runtime: 1 s fallback bandwidth filter window before first RTT sample arrives.
        ...
        /// </remarks>
        public const int BENCHMARK_100_MBPS_BYTES_PER_SECOND = 100000000 / 8; // Runtime: 12.5 MB/s — benchmark link rate for 100 Mbps test scenarios.

        /// <summary>Benchmark bandwidth for 1 Gbps line-rate scenarios, in bytes per second.</summary>
        /// <remarks>
        /// 1,000,000,000 / 8 = 125,000,000 B/s.
        /// </remarks>
        public const int BENCHMARK_1_GBPS_BYTES_PER_SECOND = 1000000000 / 8; // Runtime: 125 MB/s — benchmark link rate for 1 Gbps test scenarios.
        ...
        /// </remarks>
        public const int BENCHMARK_10_GBPS_BYTES_PER_SECOND = 10000000000L / 8 > int.MaxValue ? int.MaxValue : (int)(10000000000L / 8); // Runtime: clamped to int.MaxValue for 32-bit safety in test calculations.
        ...
        /// </remarks>
        public const int BENCHMARK_INITIAL_PROBE_BANDWIDTH_BYTES_PER_SECOND = 1000000 / 8; // Runtime: 125 KB/s starting probe rate for convergence tests.
        ...
        /// </remarks>
        public const int BENCHMARK_INITIAL_PROBE_BANDWIDTH_DIVISOR = 128; // Runtime: initial probe = line_rate / 128; computed at test setup.
        ...
        /// </remarks>
        public const int BENCHMARK_RTT_PATH_MULTIPLIER = 2; // Runtime: one-way delay × 2 → RTT for BDP/benchmark estimation.
        ...
        /// </remarks>
        public const double BENCHMARK_INITIAL_CWND_BDP_GAIN = 1.25d; // Runtime: initial CWND = BDP × 1.25 for no-loss benchmark scenarios.
        ...
        /// </remarks>
        public const int BENCHMARK_NO_LOSS_INITIAL_CWND_BANDWIDTH_DIVISOR = 16; // Runtime: CWND floor = line_rate / 16 for no-loss benchmarks.
        ...
        /// </remarks>
        public const double BENCHMARK_LOSS_INITIAL_CWND_BDP_GAIN = 4.0d; // Runtime: initial CWND = BDP × 4.0 for lossy benchmark scenarios.
        ...
        /// </remarks>
        public const double BENCHMARK_WEAK_NETWORK_INITIAL_CWND_BDP_GAIN = 8.0d; // Runtime: initial CWND = BDP × 8.0 for weak/long-RTT benchmarks.
        ...
        /// </remarks>
        public const long BENCHMARK_WEAK_NETWORK_PROBE_RTT_INTERVAL_MICROS = 120000000L; // Runtime: 120 s ProbeRTT interval for weak-network benchmarks; avoids frequent throughput dips.
        ...
        /// </remarks>
        public const double BENCHMARK_LONG_RUNNING_SERIAL_SECONDS = 10d; // Runtime: >10 s benchmarks → classified as long-running → extended ProbeRTT interval.
        ...
        /// </remarks>
        public const int BENCHMARK_MAX_LOSS_INITIAL_CWND_BYTES = 128 * 1024 * 1024; // Runtime: caps lossy-benchmark CWND at 128 MB to prevent absurd BDP×gain products.
        ...
        /// packet loss.
        /// </remarks>
        public const long BENCHMARK_LONG_FAT_MIN_RTO_MICROS = MICROS_PER_SECOND; // Runtime: 1 s RTO floor for long-fat benchmarks; prevents simulator false timeouts.
        ...
        /// </remarks>
        public const int BENCHMARK_LIGHT_RANDOM_LOSS_SEED = 20260501; // Runtime: Mersenne Twister seed for light-loss (1%) benchmark loss pattern.

        /// <summary>Deterministic random seed used by heavy-loss benchmark data drops.</summary>
        public const int BENCHMARK_HEAVY_RANDOM_LOSS_SEED = 20260502; // Runtime: Mersenne Twister seed for heavy-loss (5%) benchmark loss pattern.
        ...
        /// </remarks>
        public const long BENCHMARK_CONTROLLER_CONVERGENCE_RTT_MICROS = 10000L; // Runtime: assumed 10 ms RTT for controller-only convergence tests (no network).
        ...
        /// </remarks>
        public const int BENCHMARK_CONTROLLER_MAX_CONVERGENCE_ROUNDS = 32; // Runtime: 32-round limit; test fails if BBR hasn't converged by then.
        ...
        /// 5 ms RTT path.
        /// </remarks>
        public const int BENCHMARK_100M_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB data transfer for 100 Mbps benchmark scenarios.

        /// <summary>Payload size used by asymmetric route benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_ASYM_PAYLOAD_BYTES = 8 * 1024 * 1024; // Runtime: 8 MB data transfer for asymmetric route benchmark scenarios.

        /// <summary>Payload size used by high-jitter weak-network benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_HIGH_JITTER_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB data transfer for high-jitter weak-network benchmarks.

        /// <summary>Payload size used by 4G weak-network benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_WEAK_4G_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB data transfer for weak-4G benchmark scenarios.
        ...
        /// </remarks>
        public const int BENCHMARK_100M_LOSS_PAYLOAD_BYTES = 32 * 1024 * 1024; // Runtime: 32 MB for 100 Mbps lossy benchmarks; larger transfer compensates for retransmission overhead.

        /// <summary>Payload size used by high-loss high-RTT benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_HIGH_LOSS_HIGH_RTT_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for high-loss high-RTT benchmarks.
        ...
        /// duration excessive.
        /// </remarks>
        public const int BENCHMARK_MOBILE_3G_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for mobile 3G lossy benchmarks.
        ...
        /// </remarks>
        public const int BENCHMARK_MOBILE_4G_PAYLOAD_BYTES = 32 * 1024 * 1024; // Runtime: 32 MB for mobile 4G high-jitter benchmarks.

        /// <summary>Payload size used by satellite benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_SATELLITE_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for satellite benchmark scenarios.

        /// <summary>Payload size used by VPN benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_VPN_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for VPN benchmark scenarios.

        /// <summary>Payload size used by the 100 Mbps long-fat-pipe benchmark, in bytes.</summary>
        public const int BENCHMARK_LONG_FAT_100M_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for 100 Mbps long-fat-pipe benchmark.

        /// <summary>Payload size used by 1 Gbps benchmark scenarios, in bytes.</summary>
        public const int BENCHMARK_1G_PAYLOAD_BYTES = 16 * 1024 * 1024; // Runtime: 16 MB for 1 Gbps benchmark scenarios.
        ...
        /// </remarks>
        public const int BENCHMARK_1G_LOSS_PAYLOAD_BYTES = 64 * 1024 * 1024; // Runtime: 64 MB for 1 Gbps lossy benchmarks; larger cover for throughput degradation.
        ...
        /// packet rate by 7.4×.
        /// </remarks>
        public const int BENCHMARK_HIGH_BANDWIDTH_MSS = 9000; // Runtime: 9 KB MSS for 10 Gbps benchmarks; 7.4× fewer packets than default 1220 MSS.
        ...
        /// </remarks>
        public const int BENCHMARK_10G_PAYLOAD_BYTES = 32 * 1024 * 1024; // Runtime: 32 MB for 10 Gbps benchmarks; verifies startup ramp, not steady state.
        ...
        /// </remarks>
        public const int BENCHMARK_BURST_LOSS_PAYLOAD_BYTES = 2 * 1024 * 1024; // Runtime: 2 MB for burst-loss benchmarks; focuses on recovery speed.
        ...
        /// </remarks>
        public const int BENCHMARK_READ_TIMEOUT_MILLISECONDS = 180000; // Runtime: 3-minute read timeout for benchmark data transfer completion.
        ...
        /// </remarks>
        public const int BENCHMARK_ACK_SETTLEMENT_TIMEOUT_MILLISECONDS = 1000; // Runtime: 1 s grace period after transfer for final ACK collection.
        ...
        /// </remarks>
        public const int BENCHMARK_BASE_PORT = 40100; // Runtime: first logical port used by benchmark tests; each scenario adds its offset.

        /// <summary>Port offset for the 1 Gbps ideal benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_GIGABIT_IDEAL = 0; // Runtime: 40100 + 0 = benchmark port for 1 Gbps ideal scenario.

        /// <summary>Port offset for the 1 Gbps heavy-loss benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_GIGABIT_LOSS5 = 1; // Runtime: 40100 + 1 = benchmark port for 1 Gbps 5% loss scenario.

        /// <summary>Port offset for the 1 Gbps light-loss benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_GIGABIT_LOSS1 = 2; // Runtime: 40100 + 2 = benchmark port for 1 Gbps 1% loss scenario.

        /// <summary>Port offset for the 100 Mbps long-fat-pipe benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_LONG_FAT_100M = 3; // Runtime: 40100 + 3 = benchmark port for 100 Mbps long-fat-pipe scenario.

        /// <summary>Port offset for the 10 Gbps benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_10G = 4; // Runtime: 40100 + 4 = benchmark port for 10 Gbps scenario.

        /// <summary>Port offset for the burst-loss benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_BURST_LOSS = 5; // Runtime: 40100 + 5 = benchmark port for burst-loss scenario.

        /// <summary>Port offset for the asymmetric route benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_ASYM_ROUTE = 6; // Runtime: 40100 + 6 = benchmark port for asymmetric route scenario.

        /// <summary>Port offset for the high-jitter benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_HIGH_JITTER = 7; // Runtime: 40100 + 7 = benchmark port for high-jitter scenario.

        /// <summary>Port offset for the weak 4G benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_WEAK_4G = 8; // Runtime: 40100 + 8 = benchmark port for weak 4G scenario.
        ...
        /// </remarks>
        public const int BENCHMARK_100M_DELAY_MILLISECONDS = 5; // Runtime: 5 ms one-way delay for 100 Mbps benchmark (metro-area link).
        ...
        /// </remarks>
        public const int BENCHMARK_1G_IDEAL_DELAY_MILLISECONDS = 1; // Runtime: 1 ms one-way delay for 1 Gbps ideal benchmark (DC-like).
        ...
        /// receive window.
        /// </remarks>
        public const int BENCHMARK_1G_LIGHT_LOSS_DELAY_MILLISECONDS = 20; // Runtime: 20 ms one-way delay for 1 Gbps light-loss benchmark (WAN).
        ...
        /// </remarks>
        public const int BENCHMARK_1G_LIGHT_LOSS_JITTER_MILLISECONDS = 3; // Runtime: 3 ms jitter for 1 Gbps light-loss benchmark.
        ...
        /// </remarks>
        public const int BENCHMARK_1G_HEAVY_LOSS_DELAY_MILLISECONDS = 30; // Runtime: 30 ms one-way delay for 1 Gbps heavy-loss benchmark.

        /// <summary>Jitter for the 1 Gbps heavy-loss benchmark, in milliseconds.</summary>
        public const int BENCHMARK_1G_HEAVY_LOSS_JITTER_MILLISECONDS = 5; // Runtime: 5 ms jitter for 1 Gbps heavy-loss benchmark.
        ...
        /// </remarks>
        public const int BENCHMARK_LONG_FAT_DELAY_MILLISECONDS = 50; // Runtime: 50 ms one-way delay for 100 Mbps long-fat-pipe benchmark (trans-oceanic).

        /// <summary>Jitter for the 100 Mbps long-fat-pipe benchmark, in milliseconds.</summary>
        public const int BENCHMARK_LONG_FAT_JITTER_MILLISECONDS = 2; // Runtime: 2 ms jitter for long-fat-pipe benchmark.
        ...
        /// </remarks>
        public const int BENCHMARK_10G_DELAY_MILLISECONDS = 1; // Runtime: 1 ms one-way delay for 10 Gbps benchmark (DC-like).
        ...
        /// </remarks>
        public const int BENCHMARK_BURST_LOSS_DELAY_MILLISECONDS = 25; // Runtime: 25 ms one-way delay for burst-loss benchmark.

        /// <summary>Jitter for the burst-loss benchmark, in milliseconds.</summary>
        public const int BENCHMARK_BURST_LOSS_JITTER_MILLISECONDS = 4; // Runtime: 4 ms jitter for burst-loss benchmark.
        ...
        /// </remarks>
        public const int BENCHMARK_ASYM_FORWARD_DELAY_MILLISECONDS = 25; // Runtime: 25 ms forward delay for asymmetric route benchmark.

        /// <summary>Backward one-way delay for the asymmetric route benchmark, in milliseconds.</summary>
        public const int BENCHMARK_ASYM_BACKWARD_DELAY_MILLISECONDS = 15; // Runtime: 15 ms backward delay for asymmetric route benchmark (different from forward).
        ...
        /// </remarks>
        public const int BENCHMARK_ASYM_JITTER_MILLISECONDS = 8; // Runtime: 8 ms jitter for asymmetric benchmark; stresses RTT estimator.
        ...
        /// </remarks>
        public const double BENCHMARK_ASYM_RANDOM_LOSS_RATE = 0.005d; // Runtime: 0.5% random loss probability per packet for asymmetric benchmark.

        /// <summary>Random data loss rate used by the high-jitter benchmark.</summary>
        public const double BENCHMARK_HIGH_JITTER_LOSS_RATE = 0.005d; // Runtime: 0.5% random loss probability for high-jitter benchmark.
        ...
        /// </remarks>
        public const double BENCHMARK_WEAK_4G_LOSS_RATE = 0.05d; // Runtime: 5% random loss probability for weak 4G benchmark.

        /// <summary>Deterministic random seed used by asymmetric route benchmark data drops.</summary>
        public const int BENCHMARK_ASYM_RANDOM_LOSS_SEED = 20260503; // Runtime: Mersenne Twister seed for asymmetric benchmark loss pattern.

        /// <summary>Deterministic random seed used by high-jitter benchmark data drops.</summary>
        public const int BENCHMARK_HIGH_JITTER_LOSS_SEED = 20260504; // Runtime: Mersenne Twister seed for high-jitter benchmark loss pattern.

        /// <summary>Deterministic random seed used by weak 4G benchmark data drops.</summary>
        public const int BENCHMARK_WEAK_4G_LOSS_SEED = 20260505; // Runtime: Mersenne Twister seed for weak 4G benchmark loss pattern.
        ...
        /// </remarks>
        public const int BENCHMARK_HIGH_JITTER_DELAY_MILLISECONDS = 50; // Runtime: 50 ms base one-way delay for high-jitter benchmark; combined with 25 ms jitter.
        ...
        /// </remarks>
        public const int BENCHMARK_HIGH_JITTER_JITTER_MILLISECONDS = 25; // Runtime: 25 ms jitter (50% of delay) for high-jitter benchmark; extreme test.
        ...
        /// and queueing delays.
        /// </remarks>
        public const int BENCHMARK_WEAK_4G_DELAY_MILLISECONDS = 80; // Runtime: 80 ms one-way delay for weak 4G benchmark (worst-case 4G latency).
        ...
        /// blackouts.
        /// </remarks>
        public const int BENCHMARK_WEAK_4G_OUTAGE_PERIOD_MILLISECONDS = 900; // Runtime: every 900 ms the weak 4G simulator induces a total packet blackout.
        ...
        /// </remarks>
        public const int BENCHMARK_WEAK_4G_OUTAGE_DURATION_MILLISECONDS = 80; // Runtime: each 4G outage lasts 80 ms (over one RTT on this path).
        ...
        /// </remarks>
        public const int NETWORK_CLASSIFIER_WINDOW_COUNT = 8; // Runtime: 8 rolling windows × 200 ms = 1.6 s of statistics for path classification.
        ...
        /// </remarks>
        public const long NETWORK_CLASSIFIER_WINDOW_DURATION_MICROS = 200000L; // Runtime: each classification window collects stats for 200 ms.
        ...
        /// </remarks>
        public const double NETWORK_CLASSIFIER_LONG_FAT_RTT_MS = 80d; // Runtime: RTT ≥ 80 ms → path classified as long-fat network.
        ...
        /// </remarks>
        public const double NETWORK_CLASSIFIER_MOBILE_LOSS_RATE = 0.03d; // Runtime: loss ≥ 3% → path classified as mobile/unstable network.
        ...
        /// well below 5 ms.
        /// </remarks>
        public const double NETWORK_CLASSIFIER_MOBILE_JITTER_MS = 20d; // Runtime: jitter ≥ 20 ms → path classified as mobile/unstable.
        ...
        /// </remarks>
        public const double NETWORK_CLASSIFIER_LAN_RTT_MS = 5d; // Runtime: RTT < 5 ms and jitter < 3 ms → path classified as LAN.
        ...
        /// </remarks>
        public const double NETWORK_CLASSIFIER_LAN_JITTER_MS = 3d; // Runtime: jitter < 3 ms (combined with RTT < 5 ms) → LAN classification.
        ...
        /// </remarks>
        public const double BENCHMARK_LIGHT_RANDOM_LOSS_RATE = 0.01d; // Runtime: 1% packet-loss probability for light-loss benchmark scenarios.
        ...
        /// </remarks>
        public const double BENCHMARK_HEAVY_RANDOM_LOSS_RATE = 0.05d; // Runtime: 5% packet-loss probability for heavy-loss benchmark scenarios.
        ...
        /// </remarks>
        public const double BENCHMARK_VERY_HEAVY_RANDOM_LOSS_RATE = 0.10d; // Runtime: 10% packet-loss probability for very-heavy-loss benchmarks.
        ...
        /// </remarks>
        public const double BENCHMARK_VERY_HEAVY_LOSS_FEC_REDUNDANCY = 0.50d; // Runtime: 50% FEC redundancy (1 repair per 2 data packets) at ≥10% loss.

        /// <summary>Medium random loss rate (>=3%) threshold for increased FEC redundancy.</summary>
        public const double BENCHMARK_MEDIUM_RANDOM_LOSS_RATE = 0.03d; // Runtime: 3% loss threshold; triggers medium FEC redundancy tier below 10%.

        /// <summary>FEC redundancy ratio for medium loss (3-10%) benchmark scenarios.</summary>
        public const double BENCHMARK_MEDIUM_LOSS_FEC_REDUNDANCY = 0.50d; // Runtime: also 50% FEC redundancy for medium loss (3–10%) benchmarks.

        /// <summary>Maximum length of a single FEC slot payload in bytes, used to validate untrusted length tables.</summary>
        /// <remarks>
        /// 1200 bytes.  Matches the maximum single-packet application-data budget
        /// (MSS minus data header size).  An FEC slot length exceeding this value
        /// indicates a corrupt or malicious repair packet.
        /// </remarks>
        ...
        /// delays.
        /// </remarks>
        public const long BENCHMARK_HIGH_RTT_FEC_THRESHOLD_MICROS = 80000L; // Runtime: RTT ≥ 80 ms → heavy FEC (0.50 redundancy) for lossy benchmarks.
        ...
        /// </remarks>
        public const int BENCHMARK_HIGH_JITTER_FEC_THRESHOLD_MS = 15; // Runtime: jitter ≥ 15 ms → FEC enabled to suppress reordering-induced SACK storms.
        ...
        /// </remarks>
        public const int BENCHMARK_BURST_LOSS_FIRST_PACKET = 16; // Runtime: first packet dropped in burst-loss benchmark; allows 15 setup-packets first.
        ...
        /// </remarks>
        public const int BENCHMARK_BURST_LOSS_PACKET_COUNT = 8; // Runtime: 8 consecutive packets dropped; forces RTO-based burst recovery.
        ...
        /// </remarks>
        public const double BENCHMARK_MIN_NO_LOSS_UTILIZATION_PERCENT = 70d; // Runtime: ≥70% line rate required to pass no-loss benchmark scenarios.
        ...
        /// </remarks>
        public const double BENCHMARK_MIN_LOSS_UTILIZATION_PERCENT = 45d; // Runtime: ≥45% line rate required to pass lossy benchmark scenarios.
        ...
        /// </remarks>
        public const double BENCHMARK_MIN_GIGABIT_LOSS5_THROUGHPUT_MBPS = 145d; // Runtime: ≥145 Mbps required to pass 1 Gbps 5%-loss benchmark.
        ...
        /// </remarks>
        public const double BENCHMARK_MAX_JITTER_DELAY_MULTIPLIER = 4d; // Runtime: benchmark fails if measured jitter > 4× configured one-way delay.
        ...
        /// </remarks>
        public const double BENCHMARK_MIN_CONVERGED_PACING_RATIO = 0.70d; // Runtime: convergence test passes if pacing ≥ 70% of target.
        ...
        /// production.
        /// </remarks>
        public const double BENCHMARK_MAX_CONVERGED_PACING_RATIO = 3.0d; // Runtime: convergence test passes if pacing ≤ 3.0× target (anti-overshoot guard).
        ...
        public const int BENCHMARK_PORT_OFFSET_MOBILE_3G = 14; // Runtime: 40100 + 14 = benchmark port for mobile 3G scenario.

        /// <summary>Port offset for the mobile 4G high-jitter benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_MOBILE_4G = 15; // Runtime: 40100 + 15 = benchmark port for mobile 4G high-jitter scenario.

        /// <summary>Port offset for the satellite benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_SATELLITE = 16; // Runtime: 40100 + 16 = benchmark port for satellite scenario.

        /// <summary>Port offset for the VPN dual-congestion benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_VPN = 17; // Runtime: 40100 + 17 = benchmark port for VPN dual-congestion scenario.

        /// <summary>Port offset for the datacenter benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_DATACENTER = 18; // Runtime: 40100 + 18 = benchmark port for datacenter scenario.

        /// <summary>Port offset for the enterprise benchmark.</summary>
        public const int BENCHMARK_PORT_OFFSET_ENTERPRISE = 19; // Runtime: 40100 + 19 = benchmark port for enterprise scenario.
        ...
        /// </remarks>
        public const int BBR_PROBE_RTT_CONGESTION_LOSS_THRESHOLD = 5; // Runtime: BBR enters ProbeRTT after 5 congestive loss events to refresh RTprop.
        ...
        /// </remarks>
        public const int DEFAULT_INITIAL_BANDWIDTH_BYTES_PER_SECOND = DEFAULT_SERVER_BANDWIDTH_BYTES_PER_SECOND; // Runtime: initial BBR bandwidth estimate equals server bandwidth cap.
        ...
        /// beyond it.
        /// </remarks>
        public const int DEFAULT_MAX_PACING_RATE_BYTES_PER_SECOND = DEFAULT_SERVER_BANDWIDTH_BYTES_PER_SECOND; // Runtime: max pacing rate starts at server bandwidth; grows with BBR.
        ...
        /// </remarks>
        public const int MAX_BUFFERED_FAIR_QUEUE_ROUNDS = 2; // Runtime: max 2 rounds of saved fair-queue credit; prevents post-idle bursts.
        ...
        /// </remarks>
        public const long PAWS_TIMEOUT_MICROS = 60000000L; // Runtime: 60 s PAWS window; stale packets with timestamp delta >60 s are dropped. // 60 seconds
        ...
        public const int SIMULATOR_BASE_PORT = 30000; // Runtime: base UDP port for the internal network simulator.
        ...
        /// </remarks>
        public const double ADAPTIVE_FEC_LOSS_THRESHOLD_PERCENT = 2d; // Runtime: adaptive FEC injection begins at ≥2% estimated loss.
        ...
        public const int DefaultInitialCongestionWindow = DEFAULT_INITIAL_CONGESTION_WINDOW; // Runtime alias: delegates to DEFAULT_INITIAL_CONGESTION_WINDOW.
        ...
        public const long ProbeRttIntervalMicros = BBR_PROBE_RTT_INTERVAL_MICROS; // Runtime alias: delegates to BBR_PROBE_RTT_INTERVAL_MICROS.
        public const long ProbeRttDurationMicros = BBR_PROBE_RTT_DURATION_MICROS; // Runtime alias: delegates to BBR_PROBE_RTT_DURATION_MICROS.
        ...
        public const int BbrProbeBwGainCount = BBR_PROBE_BW_GAIN_COUNT; // Runtime alias: delegates to BBR_PROBE_BW_GAIN_COUNT.
        public const int MinBbrStartupFullBandwidthRounds = BBR_MIN_STARTUP_FULL_BANDWIDTH_ROUNDS; // Runtime alias: delegates to BBR_MIN_STARTUP_FULL_BANDWIDTH_ROUNDS.
        public const double BbrStartupGrowthTarget = BBR_STARTUP_GROWTH_TARGET; // Runtime alias: delegates to BBR_STARTUP_GROWTH_TARGET.
