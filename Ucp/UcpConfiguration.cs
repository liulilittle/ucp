...
namespace Ucp
{
    ...
    public class UcpConfiguration
    {
        ...
        public int RecvWindowPackets = UcpConstants.DEFAULT_RECV_WINDOW_PACKETS;
        ...
        /// <summary>
        /// Enables the ECN-CE EWMA and proportional gain backoff path
        /// (KCC 2.0 default: disabled, mirroring tcp_kcc.c kcc_ecn_enable=0).
        /// When enabled, CE-marked segments feed a 3/4 EWMA that reduces
        /// cwnd_gain proportionally when queuing delay exceeds congestion.
        /// </summary>
        public bool EcnEnabled = false;

        public bool EnableMtuDiscovery = true;
        public int MtuProbeMax = UcpConstants.MTU_PROBE_MAX;

        public long MtuProbeTimeoutMicros = UcpConstants.MTU_PROBE_TIMEOUT_MICROS;

        public long MtuProbeIntervalMicros = UcpConstants.MTU_PROBE_INTERVAL_MICROS;
